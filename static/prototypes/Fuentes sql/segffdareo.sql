...
(APLICATIVO CHAR (3)     NOT NULL DEFAULT '' ,
 ...
 VRFBLQ     CHAR (1)     NOT NULL DEFAULT '' ,
 Constraint SEGFFDAREO_PK Primary Key(APLICATIVO, PROCESO,
                                      BIBLIOTECA, ARCHIVO)
) RcdFmt @RDAREO;

Label On Table &LIB/SEGFFDAREO Is 'Reorganización de archivos';

Label On Column  &LIB/SEGFFDAREO
...
(APLICATIVO    Text Is   'Aplicativo' ,
 ...
 VRFBLQ        Text Is   'Verificar bloqueo'
 );
